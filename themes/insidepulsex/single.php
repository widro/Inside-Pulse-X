...
?>
				<?php if(has_tag("Inside Instagram", $post )){ echo "<div class='pulseofinstagram'><img src='http://wrestling.insidepulse.com/wp-content/uploads/2014/07/pulseofinstagramtemp3.jpg' style='padding:0px;width:750px;' />"; } ?>
				<?php if(has_tag("Pulse of Twitter", $post )){ echo "<div class='pulseofinstagram'><img src='http://media.insidepulse.com/shared/images/vx/pulseontwitter1600_insidepu.jpg' style='padding:0px;width:750px;' />"; } ?>
				<?php if(has_tag("Smackdown Spoilers", $post )){ echo "<div class='smackdownspoilers'><img src='http://wrestling.insidepulse.com/wp-content/uploads/2014/07/template1600_smackdownspoil.jpg' style='padding:0px;width:750px;' />"; } ?>
				<?php if(has_tag("wwe network schedule", $post )){ echo "<div class='wwenetworkschedule'><img src='http://media.insidepulse.com/shared/images/vx/wwenetworkdaily.jpg' style='padding:0px;width:750px;' />"; } ?>
				<?php if(has_tag("MLB Daily Schedule", $post )){ echo "<div class='mlbdaily'><img src='http://media.insidepulse.com/shared/images/vx/template1600_todaymlb.jpg' style='padding:0px;width:750px;' />"; } ?>
				<?php if(has_tag("MLB Daily Scoreboard", $post )){ echo "<div class='mlbdaily'><img src='http://media.insidepulse.com/shared/images/vx/wwenetworkdaily.jpg' style='padding:0px;width:750px;' />"; } ?>
				<?php if(has_tag("poll of the week", $post )){ echo "<div class='pollarticle'><img src='http://media.insidepulse.com/shared/images/vx/polloftheweek1600_pulse.jpg' style='padding:0px;width:750px;' />"; } ?>
				<?php if(has_tag("weekend poll", $post )){ echo "<div class='pollarticle'><img src='http://media.insidepulse.com/shared/images/vx/weekendpoll1600_pulse.jpg' style='padding:0px;width:750px;' />"; } ?>
				<?php if(has_tag("SmarK WWE Network Raw Rant", $post )){ echo "<div class='pollarticle'><img src='http://wrestling.insidepulse.com/wp-content/uploads/2014/08/smark_wwenetwork_raw.jpg' style='padding:0px;width:750px;' />"; } ?>
				<?php if(has_tag("calendar", $post )){ echo "<div class='pollarticle'><img src='http://insidepulsedev.com/wp-content/themes/insidepulsex/images/calendar.jpg' style='padding:0px;width:750px;' />"; } ?>
				<?php if(has_tag("Pulse Video", $post )){ echo "<div class='pollarticle'><img src='http://insidepulsedev.com/wp-content/themes/insidepulsex/images/video.jpg' style='padding:0px;width:750px;' />"; } ?>
...
div.pulseofinstagram div.caption{
	...
	margin:5px;
			...
			<div class="article_body <?php echo $articlebodyhide; ?>">
				...
				<img src="<?php echo $topstory500x250; ?>" alt="" title="" width="720" height="360" style="padding-bottom:10px;"/>
				...
				<?php if(has_tag("Inside Instagram", $post )){ echo "</div>"; } ?>
				<?php if(has_tag("Pulse of Twitter", $post )){ echo "</div>"; } ?>
				...
				<?php if(has_tag("calendar", $post )){ echo "</div>"; } ?>
				<?php if(has_tag("Pulse Video", $post )){ echo "</div>"; } ?>
