...
function IPiframe_add_options_page() {
	...
	add_submenu_page( 'index.php', 'Temp Admin', 'Temp Admin', 'upload_files', 'iframes?frame=email', 'IPiframe_tempadmin_page');
...
<iframe name=images_iframe src=http://insidepulse.com/images style='width:100%; height: 600px; overflow-x: hidden; overflow-y: scroll; border:0;></iframe>
...
<iframe name=images_iframe src=http://insidepulse.com/staffxls style='width:100%; height: 600px; overflow-x: hidden; overflow-y: scroll; border:0;></iframe>
...
<div class=\"wrap\">
	<div id=\"icon-index\" class=\"icon32\"><br /></div>
	<h2>Admin</h2>
	<iframe name=images_iframe src=http://insidepulse.com/admin style='width:100%; height: 600px; overflow-x: hidden; overflow-y: scroll; border:0;></iframe>
</div>
";

}

function IPiframe_tempadmin_page() {

echo "
<div class=\"wrap\">
	<div id=\"icon-index\" class=\"icon32\"><br /></div>
	<h2>Temp Admin</h2>
	<iframe name=email_iframe src='/wp-content/themes/insidepulsex/tempadmin.php' style='width:100%; height: 600px; overflow-x: hidden; overflow-y: scroll; border:0;></iframe>
</div>
";
...
<div class=\"wrap\">
	<div id=\"icon-index\" class=\"icon32\"><br /></div>
	<h2>Staff Forum</h2>
	<iframe name=staff_iframe src=/forums/ style='width:100%; height: 600px; overflow-x: hidden; overflow-y: scroll; border:0;></iframe>
</div>
";
...
function create_authbox($insider_userid, $area, $authorslug = "insider"){
	...
	elseif($area=="rightauthbox"){
		...
		$output = "
				<div class=\"rightcontainer_cell\">
					<a href=\"$authorlink\" alt=\"$insider_display_name's Profile\" title=\"$insider_display_name's Profile\"><img src=\"$insider_avatar120\" class=\"right_greybox_avatar120\"></a>
					<div class=\"rightcontainer_cell_text\">
						$createsection_body
					</div>
					<div class=\"rightcontainer_cell_line\"></div>
					<div class=\"clear\"></div>
				</div>
		";
	}
...
{
  return array( 'width' => 720, 'height' => 590 );
}
